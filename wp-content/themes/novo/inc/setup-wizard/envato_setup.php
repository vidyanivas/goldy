  ...
  class Envato_Theme_Setup_Wizard {
    ...
    public function init_wizard_steps() {
      ...
      $this->steps['verification'] = array(
        'name' => esc_html__('License activation', 'novo'),
      ...
      $this->steps['help_support'] = array(
        'name' => esc_html__('Support Policy', 'novo'),
    ...
    public function setup_wizard() {
      ...
      wp_register_script('jquery-blockui', $this->plugin_url . 'inc/setup-wizard/js/jquery.blockUI.js', array('jquery'), '2.70', true);
      wp_register_script('envato-setup', $this->plugin_url . 'inc/setup-wizard/js/envato-setup.js', array(
        'jquery',
        'jquery-blockui',
      ), $this->version);
      ...
      $show_content = true;
      echo '<div class="envato-setup-content '.esc_attr($this->step).'">';
    ...
    public function setup_wizard_header() { ?>
		<!DOCTYPE html>
		<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?> class="html-envato">
      <head>
      ...
      <body class="envato-setup wp-core-ui">
        <div class="logo-block">
          <a href="https://themeforest.net/item/novo-photography-wordpress-theme/20701463" target="_blank">
            <img src="<?php echo esc_url($this->plugin_url . 'images/setup-wizard-logo.png'); ?>" alt="Envato install wizard" />
          </a>
        </div>
		<?php }
    ...
    public function setup_wizard_footer() { ?>
        <div class="envato-setup-bottom">
          <div class="container">
            <div class="best">
              <div class="t"><span>#1</span> Weekly Bestseller</div>
              <div class="th">photography theme</div>
            </div>
            <div class="dev-logo">
              <a href="https://themeforest.net/user/ypromo/portfolio" target="_blank">
                <img src="<?php echo esc_url($this->plugin_url . 'images/promo-logo.png'); ?>" alt="Promo Theme" />
              </a>
            </div>
          </div>
        </div>
    ...
    public function setup_wizard_steps() {
      ...
      ?>
      <div class="setup-wizard-title"><?php echo esc_html__('Setup Wizard', 'novo') ?></div>
    ...
    public function envato_setup_introduction() { ?>
      <div class="envato-setup-content step-start">
        <h1><?php echo esc_html__('Welcome to the setup wizard for Novo WordPress theme.', 'novo') ?></h1>
        <div class="text"><?php echo esc_html__('It looks like you may have recently upgraded to this theme. Great! This setup wizard will help ensure all the default settings are correct. It will also show some information about your new website and support options.', 'novo') ?></div>
        <div class="buttons">
          <a href="<?php echo esc_url(wp_get_referer() && !strpos(wp_get_referer(), 'update.php') ? wp_get_referer() : admin_url('')); ?>" class="wis-button bordered button-next"><?php esc_html_e('Not right now', 'novo'); ?></a>
          <a href="<?php echo esc_url($this->get_next_step_link()); ?>" class="wis-button button-next"><?php esc_html_e('Let\'s Go!', 'novo'); ?></a>
        </div>
      </div>
    <?php }
    ...
    public function envato_setup_default_plugins() {
      ...
      ?>
      <div class="envato-setup-content step-plugin">
        <form method="post">
          <?php if (count($plugins['all'])) { ?>
            <h1><?php echo esc_html__('Required plugin to install.', 'novo') ?></h1>
          ...
          <?php } else { ?>
            <h1><?php echo esc_html__('Good news! All plugins are already installed and up to date. Please continue.', 'novo') ?></h1>
          <?php } ?>
          <div class="buttons">
            <a href="<?php echo esc_url($this->get_next_step_link()); ?>" class="wis-button bordered button-next"><?php esc_html_e('Skip this step', 'novo'); ?></a>
            <a href="<?php echo esc_url($this->get_next_step_link()); ?>" class="wis-button button-next" data-callback="install_plugins"><?php esc_html_e('Continue', 'novo'); ?></a>
...
$option = envato_market()->get_options();
    ...
    public function envato_setup_help_support() { ?>
      <h1><?php echo esc_html__('Help and Support policy.', 'novo') ?></h1>
      
      <div class="text"><?php echo esc_html__('This theme includes 6 months of support (from the purchase date). The standard license allows using one license on one Project/Domain. If you need to use it on different sites - you need to purchase additional licenses.', 'novo') ?></div>

      <div class="row">
        <div class="col">
          <div class="title-h"><?php echo esc_html__('Item Support', 'novo') ?> <span><?php echo esc_html__('includes', 'novo') ?></span>:</div>
          <ul>
        ...
        <div class="col">
          <div class="title-h not"><?php echo esc_html__('Item Support', 'novo') ?> <span><?php echo esc_html__('doesn’t includes', 'novo') ?></span>:</div>
          <ul>
      ...
      <div class="buttons">
        <a href="<?php echo esc_url($this->get_next_step_link()); ?>" class="wis-button button-next" data-callback="install_plugins"><?php esc_html_e('Agree and Continue', 'novo'); ?></a>
      </div>
    <?php }
    ...
    ?>
			...
			<h1><?php esc_html_e('Congragulations! Novo Theme was sucessfully installed.', 'novo'); ?></h1>

			<p><?php echo esc_html__('The theme has been activated and ready to work. Login to your WordPress Dashboard to make changes and modify necessary page.', 'novo') ?></p>
			<div class="envato-setup-next-steps">
				<div class="envato-setup-next-steps-last">
					<h2><?php esc_html_e('Useful resources:', 'novo'); ?></h2>
					<ul>
						<li class="documentation"><a href="https://support.promo-theme.com/novo/" target="_blank"><?php esc_html_e('Theme Documentation', 'novo'); ?></a></li>
						<li class="ticket"><a href="https://support.promo-theme.com/tickets/" target="_blank"><?php esc_html_e('Submit a support ticket', 'novo'); ?></a></li>
						<li class="rating"><a href="https://themeforest.net/item/novo-photography-wordpress-theme/reviews/20701463" target="_blank"><?php esc_html_e('Rate this theme', 'novo'); ?></a></li>
						<li class="howto"><a href="https://wordpress.org/support/" target="_blank"><?php esc_html_e('Learn how to use WordPress', 'novo'); ?></a></li>
					</ul>
				</div>
			</div>
      <div class="buttons">
        <a href="<?php echo esc_url(admin_url()); ?>" class="wis-button button-next" target="_blank"><?php esc_html_e('Finish setup', 'novo'); ?></a>
      </div>
    <?php }
