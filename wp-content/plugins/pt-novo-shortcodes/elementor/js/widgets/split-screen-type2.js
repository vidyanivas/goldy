class SplitScreen2Handler extends elementorModules.frontend.handlers.Base {
	getDefaultSettings() {
		return {
...
jQuery(window).on('elementor/frontend/init', () => {
	const addHandler = ($element) => {
		elementorFrontend.elementsHandler.addHandler(SplitScreen2Handler, {
			$element,
		});
	};

	elementorFrontend.hooks.addAction('frontend/element_ready/yprm_split_screen_type2.default', addHandler);
});